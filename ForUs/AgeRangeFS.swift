...
struct AgeRangeFS: View {
    ...
    func retrieveStuff()
    {
        ...
        docRef.whereField("ageRange", isEqualTo: "13-18").getDocuments() { (querySnapshot, err) in
            if let err = err {
...
//                            }
                            ...
                            let qR = dumm4+dumm5+dumm6+dumm7+dumm8
                            print("Quick Remdies sessions for 13-18 age range: \(qR)")
                            
                            let aYD = dumm11+dumm12+dumm13+dumm14+dumm19
                            print("Ace your Day sessions for 13-18 age range: \(aYD)")
                            
                            let sL = dumm9+dumm10+dumm15+dumm16
                            print("Student Living sessions for 13-18 age range: \(sL)")
                            
                            let mAW = dumm17+dumm18+dumm20+dumm21+dumm15
                            print("Mindfulness At Work sessions for 13-18 age range: \(mAW)")
                            
                            let selfLove = dumm22+dumm23+dumm24+dumm25+dumm26
                            print("Self Love sessions for 13-18 age range: \(selfLove)")
                            
                            let bM = dumm27+dumm28+dumm29
                            print("Beginner Mindfulness sessions for 13-18 age range: \(bM)")
...
//                        }
    ...
    func retrieveStuff1()
    {
        ...
        docRef.whereField("ageRange", isEqualTo: "18-25").getDocuments() { (querySnapshot, err) in
            if let err = err {
                        print("Error getting documents: \(err)")
                    } else {
                        for document in querySnapshot!.documents {
...
//                        }
    ...
    func retrieveStuff2()
    {
        ...
        docRef.whereField("ageRange", isEqualTo: "25-45").getDocuments() { (querySnapshot, err) in
            if let err = err {
                        print("Error getting documents: \(err)")
                    } else {
                        for document in querySnapshot!.documents {
...
//                        }
    ...
    func retrieveStuff3()
    {
        ...
        docRef.whereField("ageRange", isEqualTo: "45-65").getDocuments() { (querySnapshot, err) in
            if let err = err {
                        print("Error getting documents: \(err)")
                    } else {
                        for document in querySnapshot!.documents {
...
//                        }
    ...
    func retrieveStuff4()
    {
        ...
        docRef.whereField("ageRange", isEqualTo: "65 and up").getDocuments() { (querySnapshot, err) in
            if let err = err {
                        print("Error getting documents: \(err)")
                    } else {
                        for document in querySnapshot!.documents {
...
struct AgeRangeFS_Previews: PreviewProvider {
