...
struct WatsonView: View {
    ...
    @State var reply = 0
    @State var firstChoice = 0
    @State var secondChoice = 0
        ...
        VStack{
           // if(self.therapyPlaying == false){
            ...
            HStack {
                ...
                {TypingFebeAnimation()}//.padding(.trailing, UIScreen.main.bounds.width - 150)}
                else{
                ...
                if (reply == 2)
                {
                    ...
                    }.padding(.leading, -50)                                .onAppear(perform: {self.lastPadding = -50})
                }
                ...
                if (reply2 == 1)
                {
                    HStack {
                        ...
                        {TypingFebeAnimation()}//.clipShape(Bubble(chat:false)).padding(.trailing, UIScreen.main.bounds.width - 150)}
                        else{
...
if (inputBar == 0 && self.timeRemaining <= 5)
    {
        ScrollView(.vertical, showsIndicators: false)
        {
            VStack{
                HStack
                {//.background(self.therapyIndex == 10 ? self.lifeBeatsColor : Color.green)
                    Button (action: {self.reply = 1;self.feelingReply = 1;
                        self.feeling = "Calm"; self.inputBar = 1;
//                        if(self.therapyIndex == 0)
//                        {
...
//                        self.therapyIndex = 0;
//                        }
//                        else if(self.therapyIndex1 == 10)
//                        {
//                        self.therapyIndex1 = 0;
//                        }
//                        else if(self.therapyIndex != 0)
//                        {
//                            self.therapyIndex1 = 10;
//                        }
                        self.timeRemaining = 5;}){
                            Text("     Calm\(self.therapyIndex == 10 ? " * " : "     ")").font(Font.custom("Nexa Bold", size: 16)).padding().foregroundColor(.white).background(self.therapyIndex == 10 ? self.lifeBeatsColor : Color.green)
                        .clipShape(FeelingBubble()).frame(width:130)}
                    Button (action: {self.reply = 1;self.feelingReply = 1;
                        self.feeling = "Grateful"; self.inputBar = 1;
//                        if(self.therapyIndex == 0)
//                        {
                        self.therapyIndex = 11;
//                        }
//                        else if(self.therapyIndex == 11)
//                        {
//                        self.therapyIndex = 0;
//                        }
//                        else if(self.therapyIndex1 == 11)
//                        {
//                        self.therapyIndex1 = 0;
//                        }
//                        else if(self.therapyIndex != 0)
//                        {
//                            self.therapyIndex1 = 11;
//                        }
                        self.timeRemaining = 5;}){
                        Text("   Grateful\(self.therapyIndex == 11 ? " * " : "   ")").font(Font.custom("Nexa Bold", size: 16)).padding().foregroundColor(.white).background(self.therapyIndex == 11 ? self.lifeBeatsColor : Color.green)
                            .clipShape(FeelingBubble()).frame(width:130)}
                }
                HStack
                {
                    Button (action: {self.reply = 1;self.feelingReply = 1;
                        self.feeling = "Motivated"; self.inputBar = 1;
                        
//                        if(self.therapyIndex == 0)
//                        {
                            self.therapyIndex = 12;
                        //}
//                        else if(self.therapyIndex == 12)
//                        {
//                        self.therapyIndex = 0;
//                        }
//                        else if(self.therapyIndex1 == 12)
//                        {
//                        self.therapyIndex1 = 0;
//                        }
//                        else if(self.therapyIndex != 0)
//                        {
//                            self.therapyIndex1 = 12;
//                        }
                        self.timeRemaining = 5;}){
                        Text("  Motivated\(self.therapyIndex == 12 ? " * " : "  ")").font(Font.custom("Nexa Bold", size: 16)).padding().foregroundColor(.white).background(self.therapyIndex == 12 ? self.lifeBeatsColor : Color.green)
                        .clipShape(FeelingBubble()).frame(width:130)}
                    Button (action: {self.reply = 1;self.feelingReply = 1;
                        self.feeling = "Happy"; self.inputBar = 1;
//                        if(self.therapyIndex == 0)
//                        {
                        self.therapyIndex = 9;
//                        }
//                        else if(self.therapyIndex == 9)
//                        {
//                        self.therapyIndex = 0;
//                        }
//                        else if(self.therapyIndex1 == 9)
//                        {
//                        self.therapyIndex1 = 0;
//                        }
//                        else if(self.therapyIndex != 0)
//                        {
//                            self.therapyIndex1 = 9;
//                        }
                        self.timeRemaining = 5;}){
                        Text("     Happy\(self.therapyIndex == 9 ? "  *  " : "     ")").font(Font.custom("Nexa Bold", size: 16)).padding().foregroundColor(.white).background(self.therapyIndex == 9 ? self.lifeBeatsColor : Color.green)
                        .clipShape(FeelingBubble()).frame(width:130)}
                }
                
                HStack
                {
                Button (action: {self.reply = 2;self.feelingReply = 1;
                    self.feeling = "Meh";
                    self.inputBar = 1;
//                    if(self.therapyIndex == 0)
//                    {
...
//                    self.therapyIndex = 0;
//                    }
//                    else if(self.therapyIndex1 == 8)
//                    {
//                    self.therapyIndex1 = 0;
//                    }
//                    else if(self.therapyIndex != 0)
//                    {
//                        self.therapyIndex1 = 8;
//                    }
                    self.timeRemaining = 5;}){
                    Text("      Meh\(self.therapyIndex == 8 ? "  *  " : "      ")").font(Font.custom("Nexa Bold", size: 16)).padding().foregroundColor(.white).background(self.therapyIndex == 8 ? self.lifeBeatsColor : Color.yellow)
                    .clipShape(FeelingBubble()).frame(width:130)}
                    Button (action: {self.reply = 2;self.feelingReply = 1;
                        self.feeling = "Sad"; self.inputBar = 1;
//                        if(self.therapyIndex == 0)
//                        {
                        self.therapyIndex = 7;
//                        }
//                        else if(self.therapyIndex == 7)
//                        {
//                        self.therapyIndex = 0;
//                        }
//                        else if(self.therapyIndex1 == 7)
//                        {
//                        self.therapyIndex1 = 0;
//                        }
//                        else if(self.therapyIndex != 0)
//                        {
//                            self.therapyIndex1 = 7;
//                        }
                        self.timeRemaining = 5;}){
                        Text("      Sad\(self.therapyIndex == 7 ? "   *   " : "       ")").font(Font.custom("Nexa Bold", size: 16)).padding().foregroundColor(.white).background(self.therapyIndex == 7 ? self.lifeBeatsColor : Color.red)
                        .clipShape(FeelingBubble()).frame(width:130)}
                }
                HStack
                {
                Button (action: {self.reply = 2; self.feelingReply = 1;
                    self.feeling = "Tired"; self.inputBar = 1;
//                    if(self.therapyIndex == 0)
//                    {
                    self.therapyIndex = 1;
//                    }
...
//                    self.therapyIndex = 0;
//                    }
//                    else if(self.therapyIndex1 == 1)
//                    {
//                    self.therapyIndex1 = 0;
//                    }
//                    else if(self.therapyIndex != 0)
//                    {
//                        self.therapyIndex1 = 1;
//                    }
                    self.timeRemaining = 5;}){
                    Text("     Tired\(self.therapyIndex == 1 ? "  *  " : "     ")").font(Font.custom("Nexa Bold", size: 16)).padding().foregroundColor(.white).background(self.therapyIndex == 1 ? self.lifeBeatsColor : Color.red)
                    .clipShape(FeelingBubble()).frame(width:130) }
                Button (action: {self.reply = 2;self.feelingReply = 1;
                    self.feeling = "Stressed"; self.inputBar = 1;
//                    if(self.therapyIndex == 0)
//                    {
                    self.therapyIndex = 2;
//                    }
...
//                    self.therapyIndex = 0;
//                    }
//                    else if(self.therapyIndex1 == 2)
//                    {
//                    self.therapyIndex1 = 0;
//                    }
//                    else if(self.therapyIndex != 0)
//                    {
//                        self.therapyIndex1 = 2;
//                    }
                    self.timeRemaining = 5;}){
                    Text("   Stressed\(self.therapyIndex == 2 ? " * " : "    ")").font(Font.custom("Nexa Bold", size: 16)).padding().foregroundColor(.white).background(self.therapyIndex == 2 ? self.lifeBeatsColor : Color.red)
                    .clipShape(FeelingBubble()).frame(width:130)}
                }
                ...
                {
                Button (action: {self.reply = 2;self.feelingReply = 1;
                    self.feeling = "Anxious"; self.inputBar = 1;
//                    if(self.therapyIndex == 0)
//                    {
                    self.therapyIndex = 3;
//                    }
...
//                    self.therapyIndex = 0;
//                    }
//                    else if(self.therapyIndex1 == 3)
//                    {
//                    self.therapyIndex1 = 0;
//                    }
//                    else if(self.therapyIndex != 0)
//                    {
//                        self.therapyIndex1 = 3;
//                    }
                    self.timeRemaining = 5;}){
                    Text("    Anxious\(self.therapyIndex == 3 ? " * " : "    ")").font(Font.custom("Nexa Bold", size: 16)).padding().foregroundColor(.white).background(self.therapyIndex == 3 ? self.lifeBeatsColor : Color.red)
                    .clipShape(FeelingBubble()).frame(width:130)}
                Button (action: {self.reply = 2;self.feelingReply = 1;
                    self.feeling = "Angry"; self.inputBar = 1;
//                    if(self.therapyIndex == 0)
//                    {
                    self.therapyIndex = 5;
//                    }
...
//                    self.therapyIndex = 0;
//                    }
//                    else if(self.therapyIndex1 == 5)
//                    {
//                    self.therapyIndex1 = 0;
//                    }
//                    else if(self.therapyIndex != 0)
//                    {
//                        self.therapyIndex1 = 5;
//                    }
                    self.timeRemaining = 5;}){
                    Text("     Angry\(self.therapyIndex == 5 ? "  *  " : "      ")").font(Font.custom("Nexa Bold", size: 16)).padding().foregroundColor(.white).background(self.therapyIndex == 5 ? self.lifeBeatsColor : Color.red)
                        .clipShape(FeelingBubble()).frame(width:130)}
                }
                HStack
                {
                Button (action: {self.reply = 2;self.feelingReply = 1;
                    self.feeling = "Demotivated"; self.inputBar = 1;
//                    if(self.therapyIndex == 0)
//                    {
                    self.therapyIndex = 4;
//                    }
...
//                    self.therapyIndex = 0;
//                    }
//                    else if(self.therapyIndex1 == 4)
//                    {
//                    self.therapyIndex1 = 0;
//                    }
//                    else if(self.therapyIndex != 0)
//                    {
//                        self.therapyIndex1 = 4;
//                    }
                    self.timeRemaining = 5;}){
                    Text("Demotivated\(self.therapyIndex == 4 ? " * " : " ")").font(Font.custom("Nexa Bold", size: 15)).padding().foregroundColor(.white).background(self.therapyIndex == 4 ? self.lifeBeatsColor : Color.red)
                    .clipShape(FeelingBubble()).frame(width:130)}
                Button (action: {self.reply = 2;self.feelingReply = 1;
                    self.feeling = "Depressed"; self.inputBar = 1;
//                    if(self.therapyIndex == 0)
//                    {
                    self.therapyIndex = 6;
//                    }
//                    else if(self.therapyIndex == 6)
//                    {
//                    self.therapyIndex = 0;
//                    }
//                    else if(self.therapyIndex1 == 6)
//                    {
//                    self.therapyIndex1 = 0;
//                    }
//                    else if(self.therapyIndex != 0)
//                    {
//                        self.therapyIndex1 = 6;
//                    }
                    self.timeRemaining = 5;}){
                        Text("  Depressed\(self.therapyIndex == 6 ? " * " : " ") ").font(Font.custom("Nexa Bold", size: 16)).padding().foregroundColor(.white).background(self.therapyIndex == 6 ? self.lifeBeatsColor : Color.red)
                    .clipShape(FeelingBubble()).frame(width:130)}
                }
            }.padding(.leading, 10)
...
struct WatsonView_Previews: PreviewProvider {
